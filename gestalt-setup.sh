...
org_plan_files="$script_dir/plugins/gestalt/skills/org-plan/scripts/org-plan-files.mjs"
org_plan_parser="$script_dir/plugins/gestalt/skills/org-plan/scripts/org-plan-parser.mjs"
...
run install -m 0644 -- "$org_plan_files" "$codex_root/lib/gestalt-org-plan/org-plan-files.mjs"
