/**
 * Session module loaders for prepared Codex bundles.
 */
...
export function createSessionLoaders(hookDir) {
  ...
  return {
    async loadSessionDB() {
      return await loadModule("session-db.bundle.mjs");
    },
    ...
    async loadExtract() {
      return await loadModule("session-extract.bundle.mjs");
    },
    async loadSnapshot() {
      return await loadModule("session-snapshot.bundle.mjs");
    },
  };
}
